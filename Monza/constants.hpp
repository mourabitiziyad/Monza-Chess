...
Bitboard random_U64_number()
{
  ...
  un1 = (Bitboard)(random_number()) & 0xFFFF;
  un2 = (Bitboard)(random_number()) & 0xFFFF;
  un3 = (Bitboard)(random_number()) & 0xFFFF;
  un4 = (Bitboard)(random_number()) & 0xFFFF;
...
void init_rand_keys()
{
  ...
  for (int piece = P; piece <= k; piece++)
    for (int sq = 0; sq < 64; sq++)
      piece_keys[piece][sq] = random_U64_number();
  for (int sq = 0; sq < 64; sq++)
    enpassant_keys[sq] = random_U64_number();
  for (int idx = 0; idx < 16; idx++)
    castling_keys[idx] = random_U64_number();
